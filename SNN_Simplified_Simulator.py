...
my_SNN=SNN_connectivity(data_shape=NUM_MFs, num_node_per_layer=NUM_GCs, K=K, \
                        ...
                        num_rewire=NUM_Rewiring, rewire_rt=Rewiring_RATE, NETWORK_DRAW=NETWORK_DRAW)
...
#my_SNN.show_edge_matrix(Title='Pruned & Reordered Graph')
my_SNN.show_GCGC_edge_matrix(Title='Pruned & Reordered Graph')
